// Snapshot of mockData contacts — seeded for every new org on first bootstrap.
// Keep in sync with artifacts/realaize/src/data/mockData.ts (best-effort).
...
export const MOCK_CONTACTS: SeedContact[] = [
