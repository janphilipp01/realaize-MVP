...
// Builder functions live in ./marketIntelFactories.ts.

import type { BenchmarkRecord, BrokerProvider, AssetClass, MarketEventRecord, RefreshJob, ReportSource } from '@/models/types';
import { modeledHistory } from '@/utils/marketIntelligence';
import { PERIOD, makeBenchmark, makeComp, makeMult, ruhrProfile } from '@/data/marketIntelFactories';
